...
PRODUCT_BUILD_PROP_OVERRIDES += \
   ...
   BUILD_DISPLAY_ID=MIUI_BETA_6.5.1-167_DHD-14_M3-2 \
   BUILD_FINGERPRINT=verizon/spyder_vzw/cdma_spyder:4.0.3/6.5.1-167_DHD-14_M3-2/${BUILD_NUMBER}:user/release-keys \
   PRIVATE_BUILD_DESC="cdma_spyder-user 4.0.3 6.5.1-167_DHD-14_M3-2 "${BUILD_NUMBER}" release-keys" \
   PRODUCT_BRAND=verizon \
   BUILD_UTC_DATE= \
