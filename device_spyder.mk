...
PRODUCT_COPY_FILES += \
    ...
    device/motorola/spyder/prebuilt/etc/powervr.ini:system/etc/powervr.ini \
    ...
    device/motorola/spyder/prebuilt/usr/keychars/omap-keypad.kcm.bin:system/usr/keychars/omap-keypad.kcm.bin \
...
#    device/motorola/spyder/prebuilt/audio/acoustics.default.so:/system/lib/hw/acoustics.spyder.so \
#    device/motorola/spyder/prebuilt/audio/alsa.omap4.so:/system/lib/hw/alsa.spyder.so \
#    device/motorola/spyder/prebuilt/audio/libaudiopolicy.so:/system/lib/libaudiopolicy.so \
#    device/motorola/spyder/prebuilt/audio/libaudiopolicy_ext.so:/system/lib/libaudiopolicy_ext.so \
#    device/motorola/targa/prebuilt/audio/libmediaext.so:/system/lib/libmediaext.so \

PRODUCT_COPY_FILES += \
    device/motorola/spyder/prebuilt/audio/libaudio.so:/system/lib/libaudio.so \
    device/motorola/spyder/prebuilt/audio/libaudio_ext.so:/system/lib/libaudio_ext.so \
    device/motorola/spyder/prebuilt/audio/libasound.so:/system/lib/libasound.so \
    device/motorola/spyder/prebuilt/audio/alsa.omap4.so:/system/lib/hw/alsa.omap4.so \
